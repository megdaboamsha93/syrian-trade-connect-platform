-- Update all example businesses to be owned by a different user
-- This prevents the original user from trying to "message themselves"
UPDATE businesses 
...
-- Create function to delete conversation
...
-- Create function to block/unblock
...
-- Create function to mute/unmute
