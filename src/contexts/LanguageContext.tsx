...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const translations = {
    ...
    'home.feature4.desc': 'Post buying requests and receive competitive quotes from verified suppliers',
      ...
      'category.Food & Agriculture': 'Food & Agriculture',
      'category.electronics': 'Electronics & Technology',
      'category.Technology': 'Technology',
      'category.textiles': 'Textiles & Clothing',
      'category.Textiles & Apparel': 'Textiles & Apparel',
      ...
      'category.Crafts & Handicrafts': 'Crafts & Handicrafts',
    ...
    ar: {
      ...
      'nav.myLogistics': 'خدمات الشحن',
      'nav.general': 'الرئيسية',
      // Analytics
      'analytics.noBusinessFound': 'لا توجد شركة مسجلة',
      'analytics.pleaseRegisterFirst': 'يرجى تسجيل شركتك أولاً لعرض التحليلات',
      'analytics.loading': 'جاري تحميل التحليلات...',
      'analytics.title': 'تحليلات الشركة',
      'analytics.trackPerformance': 'تتبع أداء شركتك',
      ...
      'analytics.dailyProfileViews': 'مشاهدات الملف اليومية خلال آخر',
      'analytics.days': 'يوم',
